...
const UserDetailsPage = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    // Add a title
    doc.setFontSize(20);
    doc.text(`User Profile: ${userDetails.firstName} ${userDetails.lastName}`, 14, 22);
    ...
    let yPos = 90;
    doc.text(`Name: ${userDetails.firstName} ${userDetails.lastName}`, 14, yPos);
    yPos += 10;
    ...
    // Save the PDF
    doc.save(`${userDetails.firstName.toLowerCase()}_${userDetails.lastName.toLowerCase()}_profile.pdf`);
  };
          ...
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent sx={{ 
                ...
                <Typography variant={isMobile ? "h6" : "h5"} sx={{ mb: 1, textAlign: 'center' }}>
