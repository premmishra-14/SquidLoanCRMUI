import DefaultLeadTable from "./DefaultLeadTable";
...
const rows = [
    { id: 1, full_name: "Aarav Sharma", dob: "15/04/1985", gender: "Male", address: "123 MG Road, Mumbai, Maharashtra", contact_no: "9876543210", email: "aarav.s@example.com", marital_status: "Married",age:"40" },
...
const DefaultLead = () => {
  return (
    <div>
      <DefaultLeadTable rows={rows} columns={columns} />
    </div>
  );
};
